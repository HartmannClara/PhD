...
%% import data
topLevelFolder = "D:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_14"; % or whatever, such as 'C:\Users\John\Documents\MATLAB\work'
...
stack_path=['D:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_14\' stack{1, 1} '\My_V4_Miniscope\Results.csv'];
list_path=['D:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_14\' stack{1, 1} '\My_V4_Miniscope\timeStamps.csv'];
...
%% chop
chop_from=datetime('2022-07-14 08:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');%chop the day
chop_to=datetime('2022-07-14 19:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
