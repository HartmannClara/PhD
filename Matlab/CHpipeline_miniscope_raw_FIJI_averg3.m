...
ko=0;
switchFW= 13;
imaging_datasets1 = folders(ko+1:switchFW-1,1);
...
for s=1:size(imaging_datasets1,1)%:5%:3%change which imaging sets here
%name paths and import
stack=cellstr(table2cell(imaging_datasets1(s,1)));
