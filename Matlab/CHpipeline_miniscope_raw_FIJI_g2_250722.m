...
%% import data
topLevelFolder = "E:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_25"; % or whatever, such as 'C:\Users\John\Documents\MATLAB\work'
%cells=13;
...
ko=0;
imaging_datasets = folders(ko+1:72,1);
...
stack_path=['E:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_25\' stack{1, 1} '\My_V4_Miniscope\Results.csv'];
list_path=['E:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\2022_07_25\' stack{1, 1} '\My_V4_Miniscope\timeStamps.csv'];
events_path=['E:\Exp_2_DM_exploration\PFC-LH\g2\1_Raw\328340226232_events.csv'];
...
%% chop
chop_from=datetime('2022-07-25 11:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');%chop the day
chop_to=datetime('2022-07-25 20:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
...
ci_data.g2.Jul25(s).session.raw_f_res = raw_f_res;
ci_data.g2.Jul25(s).session.events = events;
ci_data.g2.Jul25(s).session.missed_frames = missed_frames;    
end
