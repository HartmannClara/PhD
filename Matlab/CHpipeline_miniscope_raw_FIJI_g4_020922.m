...
%% import data
topLevelFolder = "E:\Exp_2_DM_exploration\PFC-LH\g4\2022_09_02"; % or whatever, such as 'C:\Users\John\Documents\MATLAB\work'
...
ko=0;
imaging_datasets = folders(ko+1:4,1);
...
stack_path=['E:\Exp_2_DM_exploration\PFC-LH\g4\2022_09_02\' stack{1, 1} '\My_V4_Miniscope\Results.csv'];
list_path=['E:\Exp_2_DM_exploration\PFC-LH\g4\2022_09_02\' stack{1, 1} '\My_V4_Miniscope\timeStamps.csv'];
...
%% chop
chop_from=datetime('2022-09-02 10:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');%chop the day
chop_to=datetime('2022-09-02 20:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
...
ci_data.g4.Sep02(s).session.raw_f_res = raw_f_res;
ci_data.g4.Sep02(s).session.events = events;
ci_data.g4.Sep02(s).session.missed_frames = missed_frames;    
end
