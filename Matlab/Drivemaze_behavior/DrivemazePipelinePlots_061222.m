...
for ii=1: numel(fn)-1
    fn1=fieldnames(events_averg.(fn{ii}));
        ...
        events_averg.(fn{ii}).ef_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{18}),3);
        events_averg.(fn{ii}).es_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{19}),3);
        events_averg.(fn{ii}).soc_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{20}),3);
        events_averg.(fn{ii}).ee_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{21}),3);
        events_averg.(fn{ii}).er_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{22}),3);
        events_averg.(fn{ii}).drink_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{23}),3);
        events_averg.(fn{ii}).eat_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{24}),3);
        events_averg.(fn{ii}).blockend_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{25}),3);
        events_averg.(fn{ii}).exd_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{26}),3);
        events_averg.(fn{ii}).exf_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{27}),3);
        events_averg.(fn{ii}).exs_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{28}),3);
        events_averg.(fn{ii}).exe_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{29}),3);
        events_averg.(fn{ii}).exr_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{30}),3);
        events_averg.(fn{ii}).run_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{31}),3);
        events_averg.(fn{ii}).expl_averg_bsl_m= nanmean(events_averg.(fn{ii}).(fn1{32}),3);
...
events_averg.all.expl = cat(2,events_averg.g5.expl_averg_bsl_m,events_averg.g2.expl_averg_bsl_m,events_averg.g4.expl_averg_bsl_m);
...
events_averg.perc.expl_cells = [(size(expl_cells,1)/all)*100 ; size(expl_cells,1)];
%inhib cells
...
events_averg.perc.expl_cells_inh = [(size(expl_cells_inh,1)/all)*100 ; size(expl_cells_inh,1)];
%% piecharts
