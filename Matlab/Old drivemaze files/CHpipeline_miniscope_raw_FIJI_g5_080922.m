...
list_path=['W:\BETA-NeuroSciences-Hypo\imaging\Data\miniscope_PFC_LH\g5_female_2022\g5_\2022_09_08\' stack{1, 1} '\My_V4_Miniscope\timeStamps.csv'];
...
ci_data.g5.Aug08(s).session.raw_f_res = raw_f_res;
ci_data.g5.Aug08(s).session.events = events;
ci_data.g5.Aug08(s).session.missed_frames = missed_frames;    
end
