...
%% import data
topLevelFolder = "E:\Exp_2_DM_exploration\PFC-LH\g7\2022_11_07"; % or whatever, such as 'C:\Users\John\Documents\MATLAB\work'
...
ko=4;
imaging_datasets = folders(ko+1:8,1);
...
stack_path=['E:\Exp_2_DM_exploration\PFC-LH\g7\2022_11_07\' stack{1, 1} '\My_V4_Miniscope\Results.csv'];
list_path=['E:\Exp_2_DM_exploration\PFC-LH\g7\2022_11_07\' stack{1, 1} '\My_V4_Miniscope\timeStamps.csv'];
events_path=['E:\Exp_2_DM_exploration\PFC-LH\g7\8502199200_events.csv'];
...
%% chop
chop_from=datetime('2022-11-07 10:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');%chop the day
chop_to=datetime('2022-11-07 20:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
