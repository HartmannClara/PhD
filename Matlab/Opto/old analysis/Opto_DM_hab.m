...
%animals = ['B'];%90 IPIpellet = 15s 08.07.24 IDI 75th perc 6s
    events_path=['C:\Users\cha206\Desktop\Opto_DM\Eb1m_events'];%enter name of the animal you want to check
    ...
    excl = vertcat(I1, I4);
    start= datetime(['2024-06-11 09:00:00.000'],'InputFormat','yyyy-MM-dd HH:mm:ss.SSS');%first proper habituation day (take from notes)
