clearvars -except events_averg events_averg_data events_averg_c1 ci_data perc95 perc5 Perc95 Perc5 Specs; close all;
% Analysis of ci_data file, creates events_averg data file
% 03/06/2023
% to do:
%% 
%g12 d1 s18 ended in social pod, entry removed
%g2 d2 s 25 false entry, deleted
...
%%%%%%%%%%%%%%%%%% for chance triggers
                            ...
                            evnt = eventNr(i);
                                ...
                                elseif trig>win+ fte +1 & p==3
                                    ...
                                    snips2(:,:,i)=raw_f(trig-10:trig+win,:); %social interact, takes 3s after beam break and 1s before
                                ...
                                elseif trig>win+ fte +1 & p==4
                                    ...
                                    snips2(:,:,i)=raw_f(trig-10:trig+win,:); %explore activity, takes 3s after beam break
...
%% exits
                                ...
                                elseif trig>win+1 & p==11
                                    ...
                                    exs_all = {fn(ii), fn1(j), s, i};
                                    SocExitAll = [SocExitAll; exs_all];
                                elseif trig>win+1 & p==12
                                    ...
                                    exe_all = {fn(ii), fn1(j), s, i};
                                    ExpExitAll = [ExpExitAll; exe_all];
                                elseif trig>win+1 & p==13
                                    ...
                                    exr_all = {fn(ii), fn1(j), s, i};
                                    RunExitAll = [RunExitAll; exr_all];
                                elseif trig>win+1 & p==14 & trig<= size(raw_f,1)%imaging stop 
                                    ...
                                    is_all = {fn(ii), fn1(j), s, i};
                                    ImgStopAll = [ImgStopAll; is_all];
