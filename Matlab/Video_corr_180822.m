...
%chop
if s==1
    chop_from=datetime('2022-07-07 11:25:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
    chop_to=datetime('2022-07-07 11:33:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
    elseif s==2
